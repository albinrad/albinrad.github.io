...
/**
 * View that prompts the admin for a specific course to search.
 * 
...
public class AdminSearchCourseView extends JFrame {
	/**
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdminSearchCourseView frame = new AdminSearchCourseView();
	...
	/**
	 * Creates the AdminSearchCourseView frame.
	 */
	public AdminSearchCourseView() {
		setResizable(false);
